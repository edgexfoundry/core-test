...
public interface AddressableData {
	...
	static Addressable newTestInstance() {
		Addressable a = new Addressable(TEST_ADDR_NAME, TEST_PROTOCOL, TEST_ADDRESS, TEST_PATH, TEST_PORT);
	...
	static void checkTestData(Addressable a, String addressableId) {
		...
		assertEquals("Addressable origin does not match expected", CommonData.TEST_ORIGIN, a.getOrigin());
